    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border">
        <div className="container flex items-center justify-between h-16">
          <div className="text-2xl font-bold">Assistente TMMi</div>
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6 text-balance">
              Descubra o Nível de Maturidade em seu processo TDM
            </h1>
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 text-balance">
              Avaliação rápida e precisa baseada no modelo TMMi. Receba insights acionáveis em minutos.
            </p>
            ...
            <div className="flex flex-col md:flex-row gap-8 justify-center items-center text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>Baseado em TMMi Oficial</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle2 className="w-5 h-5 text-accent" />
      ...
      <section className="py-20 md:py-32 bg-card border-t border-border">
        <div className="container">
          <div className="max-w-3xl mx-auto mb-16 text-center">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Escolha Seu Tipo de Diagnóstico</h2>
            <p className="text-lg text-muted-foreground">
              Ambos são baseados no TMMi. A diferença está no nível de profundidade.
            </p>
          </div>
            ...
            <Card className="relative border-2 border-accent/20 hover:border-accent/50 transition">
              ...
              <CardContent>
                ...
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-accent mt-0.5 flex-shrink-0" />
                    <span className="text-sm">Nível TMMi + 3 principais gaps</span>
                  </li>
                  <li className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-accent mt-0.5 flex-shrink-0" />
